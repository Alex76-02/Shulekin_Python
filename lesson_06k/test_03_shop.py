...
def test_03_shop(driver):
    ...
    driver.find_element(By.CSS_SELECTOR, "#first-name").send_keys("Шулекин")
    driver.find_element(By.CSS_SELECTOR, "#last-name").send_keys("Александр")
    driver.find_element(By.CSS_SELECTOR, "#postal-code").send_keys("397631")
